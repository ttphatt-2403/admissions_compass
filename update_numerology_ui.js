...
fs.writeFileSync(path.join(__dirname, 'src/components/NumerologyTest.tsx'), content, 'utf-8');
console.log('Successfully updated NumerologyTest.tsx with new deep psychology UI!');
