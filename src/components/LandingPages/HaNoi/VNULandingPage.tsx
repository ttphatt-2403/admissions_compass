...
const VNULandingPage = () => {
  ...
  const VNU_BLUE = 'rgb(13, 53, 128)';
  const VNU_GOLD = '#D4AF37';
  const VNU_GREEN = 'rgb(6, 134, 89)';
  ...
  return (
    <div className="font-sans text-slate-800 bg-white min-h-screen flex flex-col">
      ...
      `}</style>
      {/* Navigation */}
      <nav className="sticky top-0 z-50 bg-white shadow-sm border-b border-[#0B2A6F]/10">
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#F39C12] shadow-md bg-white">
                <img
                  src="https://th.bing.com/th/id/OIP.qeyoBdlZZGMyTGJ-z2PumQHaHa?w=174&h=180&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3"
                  className="w-full h-full object-contain p-1"
                />
              </div>
              <div>
                <span className="block font-bold text-lg text-[#0B2A6F] leading-none">ĐẠI HỌC QUỐC GIA</span>
                <span className="block text-sm font-medium text-slate-500 tracking-wider">HÀ NỘI</span>
              </div>
            </div>

            <div className="hidden lg:flex items-center space-x-8">
              <a href="#introduction" className="text-slate-700 hover:text-[#0B2A6F] font-medium transition-colors text-sm uppercase tracking-wide">Giới thiệu</a>
              <a href="#faculties" className="text-slate-700 hover:text-[#0B2A6F] font-medium transition-colors text-sm uppercase tracking-wide">Đơn vị đào tạo</a>
              <a href="#research" className="text-slate-700 hover:text-[#0B2A6F] font-medium transition-colors text-sm uppercase tracking-wide">Nghiên cứu</a>
              <a href="#admissions" className="text-slate-700 hover:text-[#0B2A6F] font-medium transition-colors text-sm uppercase tracking-wide">Tuyển sinh</a>
            </div>

            <button
              onClick={() => document.getElementById('consultation-form')?.scrollIntoView({ behavior: 'smooth' })}
              className="hidden md:flex items-center gap-2 text-white px-6 py-2.5 rounded-sm font-semibold transition-all shadow-md transform hover:-translate-y-0.5"
              style={{ backgroundColor: VNU_GREEN }}
            >
              Cổng thông tin
            ...
            <div className="lg:hidden">
              <button className="text-[#0B2A6F] p-2">
      ...
      {/* Hero Section */}
      <section className="relative h-[600px] md:h-[700px] overflow-hidden bg-[#071B3A]">
        <div className="absolute inset-0 z-0">
          <img
            ...
            decoding="async"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0B2A6F]/90 via-[#0B2A6F]/40 to-transparent"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
          <div className="max-w-3xl animate-fade-in-up">
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-bold text-white leading-tight mb-6">
              ...
              <span className="text-[#D4AF37]">Kiến tạo Tương lai</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                onClick={() => document.getElementById('consultation-form')?.scrollIntoView({ behavior: 'smooth' })}
                className="px-8 py-4 rounded-sm font-bold text-lg shadow-lg transition-all hover:brightness-95 hover:shadow-[rgba(212,175,55,0.35)] flex items-center justify-center gap-2"
                style={{ backgroundColor: VNU_GOLD, color: VNU_GREEN }}
              >
                Đăng ký xét tuyển
                <ArrowRight className="w-5 h-5" />
              </button>
              <button className="px-8 py-4 bg-white/5 border border-white/50 text-white rounded-sm font-bold text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2">
        ...
        {/* Stats Strip */}
        <div className="absolute bottom-0 w-full bg-[#0B2A6F]/85 backdrop-blur-md border-t border-white/10 hidden md:block">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="md:w-1/2">
              <div className="relative">
                ...
                <img
                  ...
                  className="rounded-2xl border border-slate-100 shadow-xl w-full"
                  loading="lazy"
                  decoding="async"
                />
                <div className="absolute bottom-8 left-8 bg-white p-4 rounded shadow-lg max-w-xs border-l-4 border-[#0B2A6F] hidden lg:block">
                  <p className="text-sm italic text-slate-600">"Chất lượng đào tạo là giá trị cốt lõi, là cam kết cao nhất với xã hội."</p>
                </div>
              </div>
            </div>
            <div className="md:w-1/2">
              <h4 className="text-[#0B2A6F] font-bold uppercase tracking-widest text-sm mb-2">Về chúng tôi</h4>
              ...
              <ul className="space-y-4 mb-8">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-[#0B2A6F] mt-0.5 shrink-0" />
                    <span className="text-slate-700">{item}</span>
                  </li>
                ))}
              </ul>
              <button className="text-[#0B2A6F] font-bold border-b-2 border-[#0B2A6F] hover:text-[#071B3A] hover:border-[#071B3A] transition-colors pb-1 inline-flex items-center gap-1">
      ...
      <section id="faculties" className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-[#0B2A6F] mx-auto mb-6"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-[#0B2A6F]/10 flex flex-col">
                <div className="h-48 overflow-hidden relative">
                  <div className="absolute inset-0 bg-[#0B2A6F]/10 group-hover:bg-[#0B2A6F]/0 transition-colors z-10"></div>
                  <img
                    src={school.img}
                    alt={school.name}
                    ...
                    decoding="async"
                  />
                  <div className="absolute top-4 left-4 bg-[#0B2A6F] text-white text-xs font-bold px-3 py-1 rounded shadow-sm">
                    {school.code}
                  </div>
                </div>
                <div className="p-6 flex-1 flex flex-col">
                  <div className="mb-4">
                    <school.icon className="w-8 h-8 text-[#0B2A6F] mb-3" />
                    <h3 className="text-xl font-bold text-slate-900 group-hover:text-[#0B2A6F] transition-colors">{school.name}</h3>
                  </div>
                  <p className="text-slate-600 text-sm mb-6 flex-1">{school.desc}</p>
                  <a href="#" className="inline-flex items-center text-[#0B2A6F] font-semibold text-sm hover:translate-x-1 transition-transform">
      ...
      <section id="research" className="py-20 bg-gradient-to-b from-[#071B3A] to-[#0B2A6F] text-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-[#08336e] skew-x-12 translate-x-1/4 opacity-35"></div>
           ...
           <div className="flex flex-col lg:flex-row gap-16">
              <div className="lg:w-1/2">
                 ...
                 <div className="grid grid-cols-2 gap-6">
                    <div className="bg-white/14 p-4 rounded border border-white/20">
                       <div className="text-3xl font-bold text-[#D4AF37] mb-1">Top 1</div>
                       <div className="text-sm text-white/85">Bảng xếp hạng đại học Việt Nam</div>
                    </div>
                    <div className="bg-white/14 p-4 rounded border border-white/20">
                       <div className="text-3xl font-bold text-[#D4AF37] mb-1">500+</div>
                       <div className="text-sm text-white/85">Đề tài cấp Nhà nước/năm</div>
                    </div>
                 </div>
              ...
              <div className="lg:w-1/2 flex items-center justify-center">
                 <div className="grid grid-cols-2 gap-4">
                    <img
                      src="https://images.unsplash.com/photo-1758685848587-7bc7487b6e85?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzY2llbnRpZmljJTIwcmVzZWFyY2glMjBsYWJvcmF0b3J5JTIwdW5pdmVyc2l0eXxlbnwxfHx8fDE3NzE0MzEyMjR8MA&ixlib=rb-4.1.0&q=80&w=1080"
                      className="rounded-lg shadow-lg translate-y-8"
                      alt="Lab"
                      loading="lazy"
                      decoding="async"
                    />
                    <img
                      src="https://images.unsplash.com/photo-1766226083712-be8e02074247?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbnRlcm5hdGlvbmFsJTIwc3R1ZGVudHMlMjBleGNoYW5nZSUyMHByb2dyYW0lMjB1bml2ZXJzaXR5fGVufDF8fHx8MTc3MTQzMTIyNHww&ixlib=rb-4.1.0&q=80&w=1080"
      ...
      <section id="admissions" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-slate-50 p-8 rounded-2xl border border-[#0B2A6F]/10">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-[#FFF2C6] rounded-lg text-[#A87400]">
              ...
              <a href="#" className="text-[#0B2A6F] font-bold text-sm hover:underline">Xem danh sách học bổng &rarr;</a>
            </div>

            <div className="bg-slate-50 p-8 rounded-2xl border border-[#0B2A6F]/10">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-[#DDE8FF] rounded-lg text-[#0B2A6F]">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center border-b border-slate-200 pb-2">
                  ...
                  <span className="font-bold text-[#0B2A6F] text-lg">96.5%</span>
                </div>
                <div className="flex justify-between items-center border-b border-slate-200 pb-2">
                  <span className="text-slate-600">Mức lương khởi điểm trung bình</span>
                  <span className="font-bold text-[#0B2A6F] text-lg">12 - 20 triệu</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-600">Làm việc tại tập đoàn đa quốc gia</span>
                  <span className="font-bold text-[#0B2A6F] text-lg">35%</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="consultation-form" className="py-20 bg-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-xl overflow-hidden flex flex-col md:flex-row">
            <div className="md:w-5/12 p-10 text-white flex flex-col justify-between relative overflow-hidden" style={{ backgroundColor: VNU_BLUE }}>
            ...
            <div className="md:w-7/12 p-10">
              {submitted ? (
                <div className="h-full flex flex-col items-center justify-center text-center animate-fade-in" role="status" aria-live="polite" aria-atomic="true">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      autoComplete="name"
                      className="w-full px-4 py-2.5 rounded border border-slate-300 focus:border-[#0B2A6F] focus:ring-1 focus:ring-[#0B2A6F] outline-none transition-all"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2.5 rounded border border-slate-300 focus:border-[#0B2A6F] focus:ring-1 focus:ring-[#0B2A6F] outline-none transition-all bg-white"
                  ...
                  <button
                    type="submit"
                    className="w-full text-white font-bold py-3 rounded shadow-md transition-all hover:brightness-95 hover:shadow-lg mt-2"
                    style={{ backgroundColor: VNU_BLUE }}
                  >
                    Gửi thông tin
                  </button>
                </form>
