        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-2xl font-black">AdmissionHub</span>
              </div>
              <p className="text-slate-400 leading-relaxed mb-6">
                Nền tảng thông tin tuyển sinh và ôn thi THPT hàng đầu Việt Nam, đồng hành cùng 500.000+ học sinh.
              </p>
              <div className="flex items-center gap-2">
                <Shield className="text-green-500" size={20} />
                <span className="text-sm text-slate-400">Tuân thủ bảo mật dữ liệu</span>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Dịch vụ</a></li>
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Đối tác</a></li>
            ...
            {/* Legal */}
            <div>
              <h3 className="font-bold text-lg mb-6">Pháp lý</h3>
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Quy chế hoạt động</a></li>
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Giải quyết khiếu nại</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-slate-400">
                <li className="flex items-start gap-2">
                  ...
                  <span>Tầng 5, Tòa nhà Innovation, Số 1 Đại Cồ Việt, Hà Nội</span>
                </li>
                <li className="flex items-center gap-2">
                  <Phone size={18} className="shrink-0" />
                  <a href="tel:0901234567" className="hover:text-white transition-colors">090 123 4567</a>
                </li>
                <li className="flex items-center gap-2">
                  <Mail size={18} className="shrink-0" />
                  <a href="mailto:info@admissionhub.vn" className="hover:text-white transition-colors">info@admissionhub.vn</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-400 text-sm">
              © 2026 AdmissionHub. All rights reserved.
            </p>
