...
export const NUMEROLOGY_PROFILES: Record<number, NumerologyProfile> = {
  1: {
    ...
    workStyle: 'Làm việc tốt nhất khi được trao toàn quyền tự chủ — không thích bị giám sát hay hỏi thăm tiến độ liên tục. Năng suất cao nhất khi có sứ mệnh rõ ràng và thách thức đủ lớn. Không giỏi multitasking nhưng xuất sắc khi tập trung vào một mục tiêu.',
    leadershipStyle: 'Lãnh đạo kiểu "Người tiên phong" — đặt ra hướng đi táo bạo và kéo người khác theo bằng sức hút cá nhân. Giỏi khởi đầu dự án và tạo đột phá nhưng cần đội ngũ hỗ trợ để duy trì vận hành lâu dài. Nguy cơ trở nên độc đoán nếu không tập lắng nghe.',
    careerAdvice: 'Tìm kiếm vai trò lãnh đạo hoặc tự kinh doanh sớm — bạn không được sinh ra để làm nhân viên suốt đời. Xây dựng personal brand mạnh vì danh tiếng là tài sản lớn nhất của bạn. Học kỹ năng cộng tác và chia sẻ thành công — đây là điểm yếu cần rèn giũa để tiến xa hơn.',
  ...
  2: {
    ...
    workStyle: 'Phát huy tốt nhất trong vai trò hỗ trợ và kết nối giữa các cá nhân. Rất nhạy cảm với môi trường — cần bầu không khí hòa thuận để làm việc hiệu quả. Chú trọng chất lượng mối quan hệ và chi tiết hơn là tốc độ kết quả.',
    leadershipStyle: 'Lãnh đạo từ phía sau — truyền cảm hứng qua sự đồng cảm và xây dựng đội nhóm gắn kết. Không thể hiện quyền lực bằng uy thế mà bằng sự tin tưởng và gắn kết cảm xúc. Giỏi hòa giải xung đột và duy trì sự đoàn kết trong nhóm.',
    careerAdvice: 'Học cách đặt ranh giới rõ ràng trong công việc — đừng để người khác lợi dụng sự tận tâm. Phát triển kỹ năng tự tin nói lên ý kiến và thương lượng quyền lợi. Công nhận giá trị của bản thân và chủ động đề xuất ý tưởng thay vì chờ được giao nhiệm vụ.',
  ...
  3: {
    ...
    workStyle: 'Làm việc theo cảm hứng — năng suất cao vào những ngày hứng khởi, thấp hơn khi bị ép buộc. Cần sự đa dạng trong công việc, ghét sự đơn điệu lặp đi lặp lại. Xuất sắc trong brainstorming, thuyết trình và tạo ra ý tưởng mới.',
    leadershipStyle: 'Lãnh đạo bằng sức hút cá nhân và tầm nhìn sáng tạo — thu hút người khác theo bằng năng lượng và lời nói. Giỏi truyền đạt tầm nhìn và tạo không khí hứng khởi nhưng cần người khác xử lý phần thực thi chi tiết.',
    careerAdvice: 'Xây dựng kỷ luật làm việc cố định để bổ trợ cho sự sáng tạo tự nhiên. Đầu tư chuyên sâu vào một lĩnh vực thay vì dàn trải — chiều sâu mới tạo ra giá trị thật. Tận dụng kỹ năng truyền đạt để xây dựng personal brand hoặc content — đây là đòn bẩy sự nghiệp mạnh nhất của bạn.',
  ...
  4: {
    ...
    workStyle: 'Làm việc có hệ thống và kế hoạch rõ ràng — không bao giờ qua loa hay bỏ sót chi tiết. Hoàn thành công việc đến nơi đến chốn, là người đáng tin cậy nhất trong nhóm. Cần không gian yên tĩnh và thời gian đủ để thực hiện tốt, không thích bị thúc ép hấp tấp.',
    leadershipStyle: 'Lãnh đạo kiểu "Kiến trúc sư hệ thống" — xây dựng quy trình vững chắc, minh bạch và nhất quán. Thực tiễn, đáng tin và là trụ cột ổn định của tổ chức. Đôi khi cứng nhắc trước thay đổi đột ngột — cần học cách linh hoạt hơn.',
    careerAdvice: 'Học cách linh hoạt và thích nghi trong môi trường thay đổi nhanh — đây là kỹ năng sống còn trong thế kỷ 21. Mạnh dạn chia sẻ ý kiến với cấp trên — sự cẩn thận và chính xác của bạn là tài sản quý. Xây dựng CV theo hướng chuyên gia chuyên sâu trong lĩnh vực kỹ thuật hoặc quản lý.',
  ...
  5: {
    ...
    workStyle: 'Làm việc tốt nhất khi có tính linh hoạt về thời gian và địa điểm. Học kỹ năng mới nhanh và thích nghi xuất sắc với thay đổi. Năng suất cao theo từng đợt bùng phát nhưng cần sự đa dạng liên tục để duy trì hứng thú.',
    leadershipStyle: 'Lãnh đạo kiểu "Nhà thám hiểm" — truyền cảm hứng dám thử cái mới và phá vỡ giới hạn cũ. Giỏi dẫn dắt đội nhóm qua giai đoạn thay đổi và bất ổn vì bản thân không sợ điều chưa biết. Cần rèn tính kiên nhẫn và khả năng duy trì cam kết lâu dài.',
    careerAdvice: 'Tìm kiếm nghề nghiệp có tính linh hoạt cao — remote work, freelance hoặc travel-based career. Tránh cam kết với công việc không phù hợp giá trị — bạn sẽ bỏ cuộc và lãng phí năng lượng. Xây dựng nhiều nguồn thu nhập để có tự do tài chính mà không bị "giam cầm" bởi một việc duy nhất.',
  ...
  6: {
    ...
    workStyle: 'Làm việc với sự tận tâm và luôn chú ý đến nhu cầu của người xung quanh. Phát huy tốt nhất trong vai trò mentor, chăm sóc và hỗ trợ. Dễ ôm đồm quá nhiều vì không nỡ từ chối — cần học cách phân chia ưu tiên rõ ràng.',
    leadershipStyle: 'Lãnh đạo kiểu "Người chăm sóc" — tạo môi trường làm việc an toàn, ấm áp và hỗ trợ lẫn nhau. Quan tâm đến phúc lợi và sự phát triển cá nhân của từng thành viên. Cần học cách đưa ra quyết định khó khăn khi cần thiết, không phải lúc nào cũng có thể làm vui tất cả.',
    careerAdvice: 'Học kỹ năng từ chối và đặt ranh giới rõ ràng để tránh kiệt sức cảm xúc. Phát triển năng lực quản lý và điều phối — bạn có thiên phú lãnh đạo nhưng cần rèn luyện thêm kỹ thuật. Tìm công việc có ý nghĩa xã hội rõ ràng để duy trì động lực và không cảm thấy trống rỗng.',
  ...
  7: {
    ...
    workStyle: 'Nghiên cứu sâu và phân tích kỹ — không bao giờ làm bề mặt. Làm việc độc lập tốt hơn nhiều so với trong nhóm. Cần thời gian yên tĩnh để xử lý thông tin — không phù hợp với môi trường ồn ào hay deadline liên tục.',
    leadershipStyle: 'Lãnh đạo kiểu "Nhà tư tưởng" — dẫn dắt bằng chuyên môn và chiều sâu kiến thức vượt trội. Không thoải mái với quyền lực thể hiện ra ngoài nhưng tạo ảnh hưởng sâu sắc qua sự hiểu biết. Cần đội ngũ có thể chuyển tư duy của bạn thành hành động thực tế.',
    careerAdvice: 'Chọn chuyên ngành có thể đào sâu 10.000 giờ — bạn sẽ trở thành chuyên gia hàng đầu trong lĩnh vực đó. Phát triển kỹ năng trình bày và giao tiếp để chia sẻ kiến thức hiệu quả — đây là cách nhân đôi giá trị của bạn. Xây dựng mạng lưới quan hệ dù không thoải mái — kết nối đúng người là bước tăng tốc sự nghiệp quan trọng nhất.',
  ...
  8: {
    ...
    workStyle: 'Làm việc với tốc độ cao, mục tiêu rõ ràng và đo lường kết quả cụ thể. Tư duy chiến lược và dài hạn — luôn thấy bức tranh lớn hơn người khác. Không ngại áp lực — thực ra cần thách thức đủ lớn để phát huy tối đa năng lực.',
    leadershipStyle: 'Lãnh đạo kiểu "Tổng tư lệnh" — quyết đoán, đặt mục tiêu cao và đòi hỏi kết quả đo được. Giỏi xây dựng đội nhóm mạnh và phân công quyền lực chiến lược. Cần tránh xu hướng kiểm soát quá mức và học cách tin tưởng đội ngũ.',
    careerAdvice: 'Đầu tư vào mạng lưới quan hệ với những người có tầm ảnh hưởng trong ngành — đây là đòn bẩy tăng trưởng nhanh nhất. Học kỹ năng quản lý và phát triển con người — nhân đôi đội ngũ là cách duy nhất để nhân đôi kết quả. Xây dựng quỹ dự phòng ổn định trước khi theo đuổi những đầu tư rủi ro cao.',
  ...
  9: {
    ...
    workStyle: 'Làm việc với sứ mệnh và tầm nhìn lớn — không thể làm những gì vô nghĩa hay chỉ vì tiền. Sáng tạo và có khả năng kết nối đa văn hóa. Làm tốt nhất khi thấy rõ tác động tích cực của công việc đến cộng đồng xung quanh.',
    leadershipStyle: 'Lãnh đạo kiểu "Nhà tiên tri nhân đạo" — truyền cảm hứng về tầm nhìn lớn hơn bản thân và kết nối người từ nhiều nền tảng khác nhau. Dẫn dắt bằng sự bao dung và trí tuệ cảm xúc, không phải bằng quyền lực hay uy quyền.',
    careerAdvice: 'Tìm cách gắn công việc với tác động xã hội để duy trì ngọn lửa bên trong. Học kỹ năng quản lý thực tế để hiện thực hóa những ý tưởng lớn — tầm nhìn cần "đôi tay" để thực thi. Đừng hi sinh bản thân quá mức — bạn cần bền vững về thể chất và tinh thần để tiếp tục cống hiến lâu dài.',
  ...
  11: {
    ...
    workStyle: 'Làm việc theo trực giác mạnh mẽ — thường đưa ra quyết định đúng mà không giải thích được lý do logic. Cần ý nghĩa sâu sắc trong từng nhiệm vụ để duy trì năng lượng. Rất nhạy cảm với môi trường và năng lượng tập thể xung quanh.',
    leadershipStyle: 'Lãnh đạo kiểu "Người soi đường" — nâng cao tầm nhìn và ý thức của tập thể bằng trực giác và tầm nhìn xa. Dẫn dắt không phải bằng quyền lực mà bằng sự thấu hiểu sâu sắc và khả năng truyền cảm hứng tâm linh. Cần người đồng hành thực tế để hiện thực hóa tầm nhìn.',
    careerAdvice: 'Học cách cân bằng trực giác với dữ liệu thực tế để thuyết phục người khác hiệu quả hơn. Tìm kiếm mentor giỏi quản lý thực tế để bù đắp điểm yếu trong tổ chức và thực thi. Đừng từ chối vai trò lãnh đạo vì khiêm tốn — thế giới cần tiếng nói và tầm nhìn của bạn.',
  ...
  22: {
    ...
    workStyle: 'Tư duy hệ thống ở cấp độ vĩ mô — luôn nhìn thấy bức tranh toàn cảnh khi người khác còn đang xử lý chi tiết. Kết hợp tầm nhìn với năng lực thực thi là điểm hiếm có. Làm việc tốt nhất trong những dự án có ý nghĩa và tầm vóc đủ lớn để thử thách.',
    leadershipStyle: 'Lãnh đạo kiểu "Nhà kiến tạo vĩ đại" — xây dựng tổ chức, hệ thống và phong trào có giá trị trường tồn. Có khả năng tập hợp người tài và phân bổ nguồn lực chiến lược ở quy mô lớn. Giỏi biến tầm nhìn 20 năm thành lộ trình thực thi rõ ràng.',
    careerAdvice: 'Tìm kiếm vai trò có tầm ảnh hưởng lớn ngay từ sớm — đừng lãng phí năng lực vào công việc nhỏ lẻ không tương xứng. Học cách giao quyền và tin tưởng đội ngũ — ôm đồm mọi thứ sẽ kìm hãm chính bạn. Kết nối với những người cùng tầm nhìn để biến những ý tưởng lớn thành hiện thực cụ thể.',
  ...
  33: {
    ...
    workStyle: 'Làm việc với toàn bộ trái tim — không thể làm gì nửa vời hay thiếu tình yêu thương. Năng lực chữa lành và nâng đỡ tinh thần người khác là bẩm sinh. Cần môi trường tôn trọng và có ý nghĩa sâu sắc để phát huy toàn bộ tiềm năng.',
    leadershipStyle: 'Lãnh đạo kiểu "Bậc thầy tâm linh" — nâng cao ý thức tập thể và chữa lành những vết thương sâu xa. Ảnh hưởng thông qua tình yêu thương vô điều kiện và trí tuệ sâu sắc, không phải quyền lực. Là ánh sáng dẫn đường cho nhiều người nhưng cần cẩn thận không bị hao mòn bởi gánh nặng của người khác.',
    careerAdvice: 'Chấp nhận sứ mệnh lớn thay vì thu mình — thế giới cần năng lượng chữa lành và tình yêu thương của bạn. Học cách bảo vệ năng lượng cá nhân và thiết lập ranh giới rõ ràng để không bị kiệt sức. Đừng cung cấp dịch vụ miễn phí liên tục — bạn xứng đáng được đền bù xứng đáng cho món quà hiếm có của mình.',
